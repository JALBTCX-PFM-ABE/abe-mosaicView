...
QString featureTypeText = 
  editFeature::tr ("This field shows the feature type.  There are two possible feature types, <b>Hydrographic</b> and "
                   "<b>Informational</b>.  In mosaicView you should only modify <b>Informational</b> features since "
                   "the underlying data cannot be marked or unmarked.  Features created in mosaicView will <b><i>always</i></b> "
                   "be created as <b>Informational</b> features.<br><br>"
                   "<b>IMPORTANT NOTE: Binary Feature Data (BFD) feature type was not available for pre-3.0 BFD files. "
                   "If you are using a preexisting pre-3.0 BFD file you will always see features flagged as <b>Hydrographic</b>. "
                   "You should probably avoid adding to or modifying features in pre-3.0 BFD files in mosaicView.</b>");
